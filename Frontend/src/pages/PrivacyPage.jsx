    ...
    <StitchLegalLayout icon={<ShieldCheck size={25} />} title="Privacy Policy" updated="Last Updated: August 2026">
      ...
      <section className="legal-section">
        ...
        <div className="legal-callout success">
          <Lock size={18} />
          <span>
            Audio processing is encrypted. Voice recordings are parsed in real time and are
      ...
      <section className="legal-section">
        ...
        <p>
          We implement industry-standard encryption protocols for data in transit and secure
          database storage for stored ledger entries.
        </p>
      </section>
      <section className="legal-section">
        <h2>5. Your Rights</h2>
        <p>
          You have the right to access, edit, export, or permanently delete your stored
          financial transactions and account details at any time through your dashboard settings.
        </p>
      </section>
      <section className="legal-section">
        <h2>6. Contact Us</h2>
